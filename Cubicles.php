...
function closeNav() {
 ...
 <h1 align="center">Cubicles - Season 2</h1>  
...
<div class="home">
    <img src="./Images/C-2(1).jpg" Width="300" Height="500">

    <h2><a href="./html movies/C-S1(EP1).html">EPISODE 1</a></h2>
    <h2><a href="./html movies/C-S1(EP2).html">EPISODE 2</a></h2>
    <h2><a href="./html movies/C-S1(EP3).html">EPISODE 3</a></h2>
    <h2><a href="./html movies/C-S1(EP4).html">EPISODE 4</a></h2>
    <h2><a href="./html movies/C-S1(EP5).html">EPISODE 5</a></h2>
