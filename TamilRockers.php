...
<h1 align="center">Tamil Rockerz</h1>  
...
<div class="home">
    ...
    <img src="./Images/TR1.jpg" Width="300" Height="500">

    <h2><a href="./html movies/TR(EP1).html">EPISODE 1 (The Pirates of The Kodambakkam)</a></h2>
    <h2><a href="./html movies/TR(EP2).html">EPISODE 2 (Aye Aye Captain)</a></h2>
    <h2><a href="./html movies/TR(EP3).html">EPISODE 3 (The Gossip Protocol)</a></h2>
    <h2><a href="./html movies/TR(EP4).html">EPISODE 4 (Seed And Leech)</a></h2>
    <h2><a href="./html movies/TR(EP5).html">EPISODE 5 (Dead Men Tell No Tales)</a></h2>
    <h2><a href="./html movies/TR(EP6).html">EPISODE 6 (Peer Tracker)</a></h2>
    <h2><a href="./html movies/TR(EP7).html">EPISODE 7 (Walk The Plank)</a></h2>
    <h2><a href="./html movies/TR(EP8).html">EPISODE 8 (Shiver Me Timbers)</a></h2>
