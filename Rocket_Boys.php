...
<h1 align="center">Rocket Boys - Season 1</h1>  
...
<div class="home">
    ...
    <img src="./Images/RB.jpg" Width="300" Height="500">

    <h2><a href="./html movies/RB(EP1).html">EPISODE 1 (War and Peace)</a></h2>
    <h2><a href="./html movies/RB(EP2).html">EPISODE 2 (Its Like Gravity)</a></h2>
    <h2><a href="./html movies/RB(EP3).html">EPISODE 3 (The Greater Good)</a></h2>
    <h2><a href="./html movies/RB(EP4).html">EPISODE 4 (A Tryst With Destiny)</a></h2>
    <h2><a href="./html movies/RB(EP5).html">EPISODE 5 (The Outsider)</a></h2>
    <h2><a href="./html movies/RB(EP6).html">EPISODE 6 (A Democratic Process)</a></h2>
    <h2><a href="./html movies/RB(EP7).html">EPISODE 7 (We Are At War)</a></h2>
    <h2><a href="./html movies/RB(EP8).html">EPISODE 8 (A New Dawn)</a></h2>
