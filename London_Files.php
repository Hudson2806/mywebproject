...
<h1 align="center">London Files - Season 1</h1>  
...
<div class="home">
    <img src="./Images/london-files.jpg" Width="300" Height="500">

    <h2><a href="./html movies/LF(EP1).html">EPISODE 1 (Missing)</a></h2>
    <h2><a href="./html movies/LF(EP2).html">EPISODE 2 (Guilty)</a></h2>
    <h2><a href="./html movies/LF(EP3).html">EPISODE 3 (Doubt)</a></h2>
    <h2><a href="./html movies/LF(EP4).html">EPISODE 4 (Loser)</a></h2>
    <h2><a href="./html movies/LF(EP5).html">EPISODE 5 (Chaos)</a></h2>
    <h2><a href="./html movies/LF(EP6).html">EPISODE 6 (Silence)</a></h2>
