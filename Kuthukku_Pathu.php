...
<h1 align="center">Kuthukku Pathu</h1>  
...
<div class="home">
    <img src="./Images/KP.webp" Width="300" Height="500">

    <h2><a href="./html movies/P_R(EP1).html">EPISODE 1 (Thulluvatho Illamai)</a></h2>
    <h2><a href="./html movies/P_R(EP2).html">EPISODE 2 (Rangasthalam)</a></h2>
    <h2><a href="./html movies/P_R(EP3).html">EPISODE 3 (Onaayum Aattukuttiyum)</a></h2>
    <h2><a href="./html movies/P_R(EP4).html">EPISODE 4 (Mandhiri Madiyil Sundhari)</a></h2>
    <h2><a href="./html movies/P_R(EP5).html">EPISODE 5 (Payum Puli Pathungum Nagam)</a></h2>
    <h2><a href="./html movies/P_R(EP6).html">EPISODE 6 (Nadunisi Naaigal)</a></h2>
    <h2><a href="./html movies/P_R(EP7).html">EPISODE 7 (Mirattal Adi)</a></h2>
