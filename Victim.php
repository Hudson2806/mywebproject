...
<div class="home">
    ...
    <img src="./Images/Victim1.jpg" Width="300" Height="500">

    <h2><a href="./html movies/Victim(EP1).html">EPISODE 1 (Dhamam)</a></h2>
    <h2><a href="./html movies/Victim(EP2).html">EPISODE 2 (Kottai Paaku Vathalum Mottai Maadi Sitharum)</a></h2>
    <h2><a href="./html movies/Victim(EP3).html">EPISODE 3 (Mirrage)</a></h2>
    <h2><a href="./html movies/Victim(EP4).html">EPISODE 4 (Confession)</a></h2>
