...
<h1 align="center"> She - Season 2</h1>  
...
<div class="home">
    ...
    <img src="./Images/She.jpeg" Width="300" Height="500">

    <h2><a href="./html movies/She(EP1).html">EPISODE 1 (The Test)</a></h2>
    <h2><a href="./html movies/She(EP2).html">EPISODE 2 (The Tightrope)</a></h2>
    <h2><a href="./html movies/She(EP3).html">EPISODE 3 (The Devil S Double)</a></h2>
    <h2><a href="./html movies/She(EP4).html">EPISODE 4 (Samsara)</a></h2>
    <h2><a href="./html movies/She(EP5).html">EPISODE 5 (Karma Cola)</a></h2>
    <h2><a href="./html movies/She(EP6).html">EPISODE 6 (Dark Seduction)</a></h2>
    <h2><a href="./html movies/She(EP7).html">EPISODE 7 (The Switch)</a></h2>
