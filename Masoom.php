...
function closeNav() {
 ...
 <h1 align="center">Masoom - Season 1</h1>  
...
<div class="home">
    <img src="./Images/Masoom1.jpg" Width="300" Height="500">

    <h2><a href="./html movies/Ma(EP1).html">EPISODE 1 (Bhulekha)</a></h2>
    <h2><a href="./html movies/Ma(EP2).html">EPISODE 2 (Muqaddar)</a></h2>
    <h2><a href="./html movies/Ma(EP3).html">EPISODE 3 (Rehnuma)</a></h2>
    <h2><a href="./html movies/Ma(EP4).html">EPISODE 4 (Family Secrets)</a></h2>
    <h2><a href="./html movies/Ma(EP5).html">EPISODE 5 (Dheeth)</a></h2>
    <h2><a href="./html movies/Ma(EP6).html">EPISODE 6 (Majnu)</a></h2>
