...
<div class="home">
    <img src="./Images/Karmegam1.jpg" Width="300" Height="500">

    <h2><a href="./html movies/KG(EP1).html">EPISODE 1 (The Storm is Ing)</a></h2>
    <h2><a href="./html movies/KG(EP2).html">EPISODE 2 (The One Of Us Knows It All)</a></h2>
    <h2><a href="./html movies/KG(EP3).html">EPISODE 3 (The Buried Truth)</a></h2>
    <h2><a href="./html movies/KG(EP4).html">EPISODE 4 (The Knife Knows The Killer)</a></h2>
    <h2><a href="./html movies/KG(EP5).html">EPISODE 5 (Is It Right To Be wrong)</a></h2>
    <h2><a href="./html movies/KG(EP6).html">EPISODE 6 (A Truth Greater Than Confession)</a></h2>
    <h2><a href="./html movies/KG(EP7).html">EPISODE 7 (An Innocent Mind Knows No Boundaries)</a></h2>
