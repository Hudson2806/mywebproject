...
function closeNav() {
 ...
 <h1 align="center">Home Shanti - Season 1</h1>  
...
<div class="home">
    <img src="./Images/HS1.jpeg" Width="300" Height="500">

    <h2><a href="./html movies/HS(EP1).html">EPISODE 1 (JOshis Ka Bhoomi Pujan)</a></h2>
    <h2><a href="./html movies/HS(EP2).html">EPISODE 2 (Ghar Ka Naksha)</a></h2>
    <h2><a href="./html movies/HS(EP3).html">EPISODE 3 (Deewaron Ki Tarai)</a></h2>
    <h2><a href="./html movies/HS(EP4).html">EPISODE 4 (Ghar Ka Lanter)</a></h2>
    <h2><a href="./html movies/HS(EP5).html">EPISODE 5 (Budget Ka Bahar Wala Interiors)</a></h2>
    <h2><a href="./html movies/HS(EP6).html">EPISODE 6 (Happy Annisary)</a></h2>
