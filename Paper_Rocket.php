...
function closeNav() {
 ...
 <h1 align="center">Paper Rocket Season 1</h1>  
...
<div class="home">
    ...
    <img src="./Images/Paper_Rocket.webp" Width="300" Height="500">

    <h2><a href="./html movies/P_R(EP1).html">EPISODE 1</a></h2>
    <h2><a href="./html movies/P_R(EP2).html">EPISODE 2</a></h2>
    <h2><a href="./html movies/P_R(EP3).html">EPISODE 3</a></h2>
    <h2><a href="./html movies/P_R(EP4).html">EPISODE 4</a></h2>
    <h2><a href="./html movies/P_R(EP5).html">EPISODE 5</a></h2>
    <h2><a href="./html movies/P_R(EP6).html">EPISODE 6</a></h2>
    <h2><a href="./html movies/P_R(EP7).html">EPISODE 7</a></h2>
