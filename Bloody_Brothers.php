...
function closeNav() {
 ...
 <h1 align="center">Bloody Brothers - Season 1</h1>  
...
<div class="home">
    <img src="./Images/BB1.jpg" Width="300" Height="500">

    <h2><a href="./html movies/BB(EP1).html">EPISODE 1 (Jaggi)</a></h2>
    <h2><a href="./html movies/BB(EP2).html">EPISODE 2 (Daljeet)</a></h2>
    <h2><a href="./html movies/BB(EP3).html">EPISODE 3 (Priya)</a></h2>
    <h2><a href="./html movies/BB(EP4).html">EPISODE 4 (Sophie)</a></h2>
    <h2><a href="./html movies/BB(EP5).html">EPISODE 5 (Sheila)</a></h2>
    <h2><a href="./html movies/BB(EP4).html">EPISODE 6 (Handa)</a></h2>
