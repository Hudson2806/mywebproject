...
function closeNav() {
 ...
 <h1 align="center">Mithya - Season 1</h1>  
...
<div class="home">
    <img src="./Images/M-1.jpg" Width="300" Height="500">

    <h2><a href="./html movies/M(EP1).html">EPISODE 1 (Maine Dekhi Hai Uski Mrityu)</a></h2>
    <h2><a href="./html movies/M(EP2).html">EPISODE 2 (Nishaane Pe Sirf Main Thi)</a></h2>
    <h2><a href="./html movies/M(EP3).html">EPISODE 3 (Sach Ke Kai Pehlu)</a></h2>
    <h2><a href="./html movies/M(EP4).html">EPISODE 4 (Sach Ki Tarah Log Bh Plex Hote Hain)</a></h2>
    <h2><a href="./html movies/M(EP5).html">EPISODE 5 (Hum Sab Mein Ek Cheat Hota Hai)</a></h2>
    <h2><a href="./html movies/M(EP4).html">EPISODE 6 (Tum Phool Si Main Kaante Si)</a></h2>
