...
<h1 align="center"> Fingertip - Season 2</h1>  
...
<div class="home">
    ...
    <img src="./Images/F1.jpg" Width="300" Height="500">

    <h2><a href="./html movies/F(EP1).html">EPISODE 1 (Enter Password Eclipse)</a></h2>
    <h2><a href="./html movies/F(EP2).html">EPISODE 2 (Hacked)</a></h2>
    <h2><a href="./html movies/F(EP3).html">EPISODE 3 (Viral Wave)</a></h2>
    <h2><a href="./html movies/F(EP4).html">EPISODE 4 (Locked Up)</a></h2>
    <h2><a href="./html movies/F(EP5).html">EPISODE 5 (The Missing Clue)</a></h2>
    <h2><a href="./html movies/F(EP6).html">EPISODE 6 (Hidden Files)</a></h2>
    <h2><a href="./html movies/F(EP7).html">EPISODE 7 (Unmasked)</a></h2>
    <h2><a href="./html movies/F(EP8).html">EPISODE 8 (Reset)</a></h2>
