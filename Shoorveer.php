...
body {background-color:black;
 ...
 h1{ color:white;
      ...
      width:400px;}    
 h3  {position:fixed;
      Top:80px; Right:10px;text-decoration:none ;
...
<h1 align="center"> Shoorveer - Season 1</h1>  
...
<div class="home">
    ...
    <img src="./Images/S-s1(1).jpeg" Width="300" Height="500">

    <h2><a href="./html movies/S(EP1).html">EPISODE 1 (The Beginning)</a></h2>
    <h2><a href="./html movies/S(EP2).html">EPISODE 2 (Agent 23)</a></h2>
    <h2><a href="./html movies/S(EP3).html">EPISODE 3 (The Pack)</a></h2>
    <h2><a href="./html movies/S(EP4).html">EPISODE 4 (Mayday Mayday Mayday)</a></h2>
    <h2><a href="./html movies/S(EP5).html">EPISODE 5 (Plan B)</a></h2>
    <h2><a href="./html movies/S(EP6).html">EPISODE 6 (The Game Begins Now)</a></h2>
    <h2><a href="./html movies/S(EP7).html">EPISODE 7 (Minutes)</a></h2>
    <h2><a href="./html movies/S(EP8).html">EPISODE 8 (Strike Back)</a></h2>
