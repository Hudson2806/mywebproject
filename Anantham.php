...
<div class="home">
    ...
    <img src="./Images/A1.png" Width="300" Height="500">

    <h2><a href="./html movies/A(EP1).html">EPISODE 1 (Maragatham)</a></h2>
    <h2><a href="./html movies/A(EP2).html">EPISODE 2 (Seetha)</a></h2>
    <h2><a href="./html movies/A(EP3).html">EPISODE 3 (Rekha)</a></h2>
    <h2><a href="./html movies/A(EP4).html">EPISODE 4 (Ananth)</a></h2>
    <h2><a href="./html movies/A(EP5).html">EPISODE 5 (Krishna Menon)</a></h2>
    <h2><a href="./html movies/A(EP6).html">EPISODE 6 (Lalitha)</a></h2>
    <h2><a href="./html movies/A(EP7).html">EPISODE 7 (Parvathy)</a></h2>
    <h2><a href="./html movies/A(EP8).html">EPISODE 8 (venkatesan)</a></h2>
