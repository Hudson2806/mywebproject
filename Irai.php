...
<div class="home">
    ...
    <img src="./Images/Irai1.jpg" Width="300" Height="500">

    <h2><a href="./html movies/Irai(EP1).html">EPISODE 1 (The Ripple Effect)</a></h2>
    <h2><a href="./html movies/Irai(EP2).html">EPISODE 2 (Skeletons in The Closet)</a></h2>
    <h2><a href="./html movies/Irai(EP3).html">EPISODE 3 (The Past)</a></h2>
    <h2><a href="./html movies/Irai(EP4).html">EPISODE 4 (The Suspect)</a></h2>
    <h2><a href="./html movies/Irai(EP5).html">EPISODE 5 (Lost And Found)</a></h2>
    <h2><a href="./html movies/Irai(EP6).html">EPISODE 6 (Truth Will Set You Free)</a></h2>
