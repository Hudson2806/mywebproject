...
<h1 align="center">9 Hours - Season 1</h1>  
...
<div class="home">
    ...
    <img src="./Images/9_hours.jpg" Width="300" Height="500">

    <h2><a href="./html movies/9H(EP1).html">EPISODE 1</a></h2>
    <h2><a href="./html movies/9H(EP2).html">EPISODE 2</a></h2>
    <h2><a href="./html movies/9H(EP3).html">EPISODE 3</a></h2>
    <h2><a href="./html movies/9H(EP4).html">EPISODE 4</a></h2>
    <h2><a href="./html movies/9H(EP5).html">EPISODE 5</a></h2>
    <h2><a href="./html movies/9H(EP6).html">EPISODE 6</a></h2>
    <h2><a href="./html movies/9H(EP7).html">EPISODE 7</a></h2>
    <h2><a href="./html movies/9H(EP8).html">EPISODE 8</a></h2>
    <h2><a href="./html movies/9H(EP9).html">EPISODE 9</a></h2>
