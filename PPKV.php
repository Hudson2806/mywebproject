...
function closeNav() {
 ...
 <h1 align="center">Putham Pudhu Kaalai Vidiyaadhaa - Season 1</h1>  
...
<div class="home">
    <img src="./Images/PPKV.jpg" Width="300" Height="500">

    <h2><a href="./html movies/PPKV(EP1).html">EPISODE 1 (Mugakavasa Mutham)</a></h2>
    <h2><a href="./html movies/PPKV(EP2).html">EPISODE 2 (Loners)</a></h2>
    <h2><a href="./html movies/PPKV(EP3).html">EPISODE 3 (Mouname Paarvayaai)</a></h2>
    <h2><a href="./html movies/PPKV(EP4).html">EPISODE 4 (The Mask)</a></h2>
    <h2><a href="./html movies/PPKV(EP5).html">EPISODE 5 (Nizhal Tharum Idham)</a></h2>
